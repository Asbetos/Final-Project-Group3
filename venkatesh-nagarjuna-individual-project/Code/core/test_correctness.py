...
from core.data import _is_qwen_tokenizer
...
def test_sample_from_logits_greedy():
    ...
    from core.sampling import sample_from_logits
...
def test_rejection_sample_greedy_accept():
    ...
    from core.sampling import rejection_sample_token
...
def test_sample_residual_distribution():
    ...
    from core.sampling import sample_residual_distribution
...
def test_bonus_token_greedy():
    ...
    from core.sampling import sample_bonus_token
...
def test_greedy_equivalence(
    ...
    """
    from core.config import PAIR_MAP
    from core.models import load_model_pair, unload_models
    from core.baseline import autoregressive_decode
    from core.speculative import speculative_decode
...
def test_tree_mask_validity():
    ...
    from core.eagle3 import TreeNode, build_tree_attention_mask
...
def test_tree_path_extraction():
    ...
    from core.eagle3 import TreeNode, _get_all_paths
...
def test_eagle3_greedy_equivalence(
    ...
    """
    from core.config import EAGLE3_PAIR_MAP
    from core.models import load_eagle3_pair, unload_models
    from core.baseline import autoregressive_decode
    from core.eagle3 import Eagle3Config, eagle3_decode
