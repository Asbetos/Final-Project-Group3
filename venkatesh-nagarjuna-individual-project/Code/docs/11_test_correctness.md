...
`scripts/test_correctness.py` is the validation script for both decoding paths in this module. It delegates to `core/test_correctness.py`.
...
1. Level 1
   Pure unit tests for `core/sampling.py`.
2. Level 2
