...
`core/baseline.py` implements plain autoregressive generation from the target model. It exists so every accelerated method can be compared against a consistent baseline.
