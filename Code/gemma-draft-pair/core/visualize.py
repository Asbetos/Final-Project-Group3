...
def load_master_csv(paths=None) -> pd.DataFrame:
    ...
    if paths is None:
        paths = [
            "artifacts/results/F_final/summary.csv",
            "artifacts/results/G_final/summary.csv",
        ]
...
def plot_speedup_vs_gamma(df: pd.DataFrame, output_dir: str = "artifacts/figures/final") -> None:
...
def plot_acceptance_rate_heatmap(df: pd.DataFrame, output_dir: str = "artifacts/figures/final") -> None:
...
def plot_pareto_frontier(df: pd.DataFrame, output_dir: str = "artifacts/figures/final") -> None:
...
def plot_draft_size_comparison(df: pd.DataFrame, output_dir: str = "artifacts/figures/final") -> None:
...
def plot_quantization_impact(df: pd.DataFrame, output_dir: str = "figures") -> None:
    ...
    spec = df[(df["is_baseline"] == False) & (df["pair_id"].isin(["F", "G"]))].copy()
    if spec.empty:
        return
    ...
    fig.suptitle(
        "Active Gemma Best-Config Comparison: Pair F vs Pair G",
        fontweight="bold",
    )
    plt.tight_layout()
    plt.savefig(
...
def plot_ttft_comparison(df: pd.DataFrame, output_dir: str = "artifacts/figures/final") -> None:
...
def plot_temperature_effect(df: pd.DataFrame, output_dir: str = "artifacts/figures/final") -> None:
...
def plot_vram_usage(df: pd.DataFrame, output_dir: str = "artifacts/figures/final") -> None:
...
def generate_all_plots(
    csv_paths = None,
    output_dir: str = "artifacts/figures/final",
) -> None:
...
if __name__ == "__main__":
    generate_all_plots(
        ...
        output_dir="artifacts/figures/final",
    )
