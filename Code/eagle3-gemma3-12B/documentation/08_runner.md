...
`runner.py` is the execution layer for experiment runs. It loads prompts, performs warmups, executes decoding, aggregates metrics, saves JSON, and appends to the master CSV.
