...
`eagle3.py` contains the core EAGLE-3 implementation used by the active Gemma-3-12B workflow.

This is the most important file in the module after `runner.py` and `eagle3_train.py`.
