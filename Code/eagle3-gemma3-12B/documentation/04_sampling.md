...
`sampling.py` contains the pure probability and rejection-sampling helpers used by both standard speculative decoding and EAGLE verification.
...
2. The vectorized batch path is especially important for the standard speculative implementation in `speculative.py`.
