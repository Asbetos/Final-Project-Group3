...
`speculative.py` contains the standard speculative decoding implementation used for target-plus-draft model pairs.
...
2. EAGLE generation does not call `speculative_decode(...)`; it uses `eagle3_decode(...)` from `eagle3.py`.
